$(document).ready(function () {
  try {
    ...
    let zipLevel = "";
    let baseUrlSection = "/ja-jp/cloud-manager-cloud-volumes-service-aws/pdfs/sidebar/";
    let zipFilename = "";
    let zipFileSize = 0;
    zipLevel = zipLevel !== ""?zipLevel:1;
    zipFilename = zipFilename !== ''?zipFilename:"cloud-manager-cloud-volumes-service-aws.ja-jp.zip";
